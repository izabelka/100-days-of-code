...
**Today's Progress:** I've created new repository. I wanted to do a react/redux course that I bought some time ago. I know it's against the rules but I feel that to proceed with react I should learn more - from courses too.
...
**Today's Progress:** I've watched the introduction and clear the repository.



## Day 39: February 13, 2017

**Today's Progress:** I've learnt how to render a react app in a different way.



## Day 40: February 15, 2017

**Today's Progress** I've created the Search Bar component using ES6 class. I've also added youtube api package and api_key and created new components.

**Thoughts:** It's fun to follow someone else's steps and see how to properly implement new apps. Also, I learnt about YouTube API.



## Day 41: February 17, 2017

**Today's Progress:** I've set App as class, add its state and added a constructor method and set state on input value change



## Day 42: February 18, 2017

**Today's Progress:** I've added code to video detail component and to video list item component to display videos properly. Also, I've added functionality to VideoListItem component.



## Day 43: February 19, 2017

**Today's Progress:** I've added a loading message when videos are still loading and added some styles as well. I've made videos from video list selectable and made searching possible. I've also added lodash and delayed refreshing by 3ms.

**Thoughts:** I've learnt about new libraries.



## Day 44: February 20, 2017

**Today's Progress:** I've refactored code and started redux course.
